...
/* package Dimension-0.0.0 */
#ifndef VERSION_Dimension
#define VERSION_Dimension "0.0.0"
#endif /* VERSION_Dimension */
#ifndef MIN_VERSION_Dimension
#define MIN_VERSION_Dimension(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_Dimension */
...
#define CURRENT_PACKAGE_KEY "Dimension-0.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "Dimension-0.0.0-inplace"
