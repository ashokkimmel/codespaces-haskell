...
/* package FromInteger-plugin-0.1.0.0 */
#ifndef VERSION_FromInteger_plugin
#define VERSION_FromInteger_plugin "0.1.0.0"
#endif /* VERSION_FromInteger_plugin */
#ifndef MIN_VERSION_FromInteger_plugin
#define MIN_VERSION_FromInteger_plugin(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_FromInteger_plugin */
...
#define CURRENT_PACKAGE_KEY "FromInteger-plugin-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "FromInteger-plugin-0.1.0.0-inplace"
